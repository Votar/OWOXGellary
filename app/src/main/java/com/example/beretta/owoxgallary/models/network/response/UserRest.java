...
public class UserRest {
    ...
    private ProfileImageRest profile_image;
    ...
    public ProfileImageRest getProfile_image() {
        return profile_image;
    }

    public void setProfile_image(ProfileImageRest profile_image) {
